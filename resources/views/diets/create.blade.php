    ...
    <div class="card border-0 shadow-sm mb-4">
      <div class="card-body">
        <div class="d-flex flex-column flex-md-row align-items-center gap-4">
          <img src="https://i.pravatar.cc/85?u=1" class="rounded-circle" width="85" height="85" alt="Ana Clara">

          <div class="flex-grow-1 text-center text-md-start">
            <h4 class="fw-bold mb-1">Ana Clara Mendes</h4>
            <p class="text-muted mb-0">Cadastrando nova dieta • Emagrecimento</p>
          </div>
        </div>
      </div>
    </div>
