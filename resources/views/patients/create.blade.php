            ...
            <div class="card col-md-10" style="margin:0px auto;">
                <div class="card-header bg-white border-0 py-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="fw-bold mb-0" style="margin:0px;">Novo Paciente</h4>
                ...
                <div class="card-body">
                    <div class="card-body p-5">
                        <form id="newClientForm" action="{{ route('patients.store') }}" method="post"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="Ex: Intolerância à lactose, alergia a frutos do mar..."
                                            name="dietaryRestrictions"> {{ old('dietaryRestrictions') }}</textarea>
                                    </div>
                            ...
                            <div class="mt-4">
                                ...
                                <textarea class="form-control"style="height:150px !important;" rows="6"
                                    placeholder="Informações adicionais relevantes..." name="observations">{{ old('observations') }}</textarea>
                            </div>
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <div style="margin-left: 15px">
                                    ...
                                    <button type="submit" style="background-color:#18976d;color:white;"
