  ...
  <nav class="navbar navbar-expand-lg main-navbar  " style="background-color:white;">
        <form class="form-inline mr-auto">
          <ul class="navbar-nav mr-3">
            ...
            <li><a href="#" data-toggle="search" class="nav-link nav-link-lg d-sm-none"><i class="fas fa-search text-white"></i></a></li>
          </ul>
          <div class="search-element" style="background-color: #645c5c2c">
            <input class="form-control" type="search" placeholder="Search" aria-label="Search" data-width="250" style="background-color: #ffffff98">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="{{asset('backend/resources/assets/img/avatar/avatar-1.png')}}" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block" style ="color: #6c757d">Olá , {{Auth()->user()->name}}</div></a>
