 <nav class="navbar navbar-expand-lg bg-white shadow-sm rounded-4 mb-4 px-4 py-3">
        <div class="container-fluid">
          ...
          <div class="d-flex align-items-center gap-3 w-100 justify-content-between">
            <h5 class="fw-semibold mb-0 "style="color:#673FD7;">Bem-vindo de volta, Nicholas! 👋</h5>
            ...
            <div class="d-flex align-items-center gap-3">
              ...
              <div class="d-flex align-items-center gap-2">
                <img src="{{asset('backend\assets\img\users\perfil_sem_foto.png')}}" class="rounded-circle" width="40" alt="Admin">
                <div>
